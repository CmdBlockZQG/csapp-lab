...
long long gen_s_data()
{
    return ((((id_ex_next->srca) != (REG_NONE)) & ((id_ex_next->srca) == 
          (ex_mem_next->deste) || (id_ex_next->srca) == (id_ex_curr->destm)
           || (id_ex_next->srca) == (ex_mem_curr->deste) || 
          (id_ex_next->srca) == (ex_mem_curr->destm) || (id_ex_next->srca)
           == (mem_wb_curr->deste) || (id_ex_next->srca) == 
          (mem_wb_curr->destm))) | (((id_ex_next->srcb) != (REG_NONE)) & (
          ...
          (mem_wb_curr->deste) || (id_ex_next->srcb) == 
          (mem_wb_curr->destm))));
}
...
long long gen_F_stall()
{
    return ((((((id_ex_next->srca) != (REG_NONE)) & ((id_ex_next->srca) == 
             ...
             & ((id_ex_next->srcb) == (ex_mem_next->deste) || 
              ...
              (id_ex_next->srcb) == (mem_wb_curr->destm)))) | ((I_RET) == 
          (if_id_curr->icode) || (I_RET) == (id_ex_curr->icode) || (I_RET)
           == (ex_mem_curr->icode))) & !(((id_ex_curr->icode) == (I_JMP))
...
long long gen_D_stall()
{
    return (((((id_ex_next->srca) != (REG_NONE)) & ((id_ex_next->srca) == 
          ...
          ((id_ex_next->srcb) == (ex_mem_next->deste) || (id_ex_next->srcb)
            ...
            (ex_mem_curr->destm) || (id_ex_next->srcb) == 
            (mem_wb_curr->deste) || (id_ex_next->srcb) == 
            (mem_wb_curr->destm)))) & !(((id_ex_curr->icode) == (I_JMP)) & 
        !(ex_mem_next->takebranch)));
}
    ...
    return ((((id_ex_curr->icode) == (I_JMP)) & !(ex_mem_next->takebranch))
       | (((I_RET) == (if_id_curr->icode) || (I_RET) == (id_ex_curr->icode)
           || (I_RET) == (ex_mem_curr->icode)) & !((((id_ex_next->srca) != 
              (REG_NONE)) & ((id_ex_next->srca) == (ex_mem_next->deste) || 
